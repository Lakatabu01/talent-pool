        ...
        <header
          ...
          <div className="flex justify-between w-[89%] mx-auto items-center lg:w-[90%]">
            ...
            <nav className="lg:flex text-base list-none hidden w-[60%]  justify-between">
              <li className="px-2">
                <Link href="/talent">Join talent pool</Link>{" "}
              </li>
              <li className="px-2">
                <Link href="/company"> Hire a talent</Link>
              </li>
            ...
            <div className="w-full text-[#484747]">
              <div className="flex flex-col my-6">
                ...
                <p className="my-3 text-sm">
                  <Link href="/talent" onClick={menuDisplay}>
                    Join Talent Pool
                  </Link>
                </p>
                <p className="text-sm">
                  <Link href="/company" onClick={menuDisplay}>
                    {" "}
                    Hire a talent
                  </Link>
                </p>
